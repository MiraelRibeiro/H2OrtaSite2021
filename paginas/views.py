...
def criarConta(request):
    ...
    if(request.method == 'POST'):
        ...
        if(form_user.is_valid()):
            ...
            # try:
            id_user = user
            nome = request.POST['first_name'] + " "+ request.POST['last_name']
            ...
            dados_usuario = TabelasDadosUsuario(id_user = id_user, nome = nome, email = email, cpf= cpf, telefone = telefone, cidade= cidade, estado=estado, pais=pais, cep=cep)
...
def comprar(request, id):
    ...
    if(request.method == 'POST'):
        ...
        dados_compra = TabelasDadosCompra(id_user= request.user, id_produto=produto, id_entrega= dados_entrega, forma_pagamento = "credito" )
        dados_compra.save()
        ...
        estufa = DadosEstufa.objects.get(pk=id)  
